 ...
 */
//#define kAPP_ID     @"194960"
//#define kAPI_Key    @"b85a19071b604466992c7840a11ee9cd"
//#define kSecret     @"6bcaeabf69a04eca94d65217cc36f447"

//#define kAPP_ID     @"197517"
//#define kAPI_Key    @"0ca1446e82d54610ab7dce09760ed1cc"
//#define kSecret     @"3b570dab8be9438aa5e59e9bbeaaa122"

#define kAPP_ID     @"183817"
#define kAPI_Key    @"f7627c19fddb4d59acbc8e9322bf4560"
#define kSecret     @"26965cc2d0764868b438f219c4d94c09"
...
@class ROWebNavigationViewController;
...
@interface Renren: NSObject <RODialogDelegate, RORequestDelegate> {
    ...
    ROWebNavigationViewController *ROWebviewController;
}
...
/**
 * 调用指定的widget dialog.通过widget Dialog的方式使用SDK.
 ...
 * @param delegate 实现RenrenDelegate协议的类型对象。
 */
- (void)dialogInNavigation:(NSString *)action andParams:(NSMutableDictionary *)params andDelegate:(id <RenrenDelegate>)delegate TitleId:(NSString *) titleId;
