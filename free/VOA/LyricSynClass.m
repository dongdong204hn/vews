...
//		offSetY += *engLines * engHight;
        ...
        UITextView *lyricCnLabel = [[UITextView alloc] initWithFrame:
                                    CGRectMake(5, offSetY, textScroll.frame.size.width-10, chSize.height+20)];
        [lyricCnLabel setContentSize:CGSizeMake(textScroll.frame.size.width-10, chSize.height+20)];
