...
- (void)viewWillAppear:(BOOL)animated  {
    ...
    if (avgTime > 0) {
        ...
        if (n > 9) {
            [avgOfDayStudyTLab setText:[NSString stringWithFormat:@"%d.%d分钟", avgTime/60, n]];
        } else {
            [avgOfDayStudyTLab setText:[NSString stringWithFormat:@"%d.0%d分钟", avgTime/60, n]];
        }
    ...
    if (n > 9) {
        [todayStudyTLab setText:[NSString stringWithFormat:@"%d.%d分钟", seconds/60, n]];
    } else {
        [todayStudyTLab setText:[NSString stringWithFormat:@"%d.0%d分钟", seconds/60, n]];
    }
